...
class DetLocalVisualizer(Visualizer):
    ...
    def _draw_instances_old(self, image: np.ndarray, instances: ['InstanceData'],
        ...
        if 'bboxes' in instances and instances.bboxes.sum() > 0:
            ...
            # draw method from mmdet 2.6.0  mmcv 1.1.5
            ...
            bboxes_with_score = np.concatenate([bboxes, scores[:, None]], axis=1)
            
            self.ax_save = mmcv.imshow_det_bboxes(
                img[:,:,::-1],
                bboxes_with_score,
                labels,
                class_names=classes,
    ...
    def add_datasample(
        ...
        if draw_pred and data_sample is not None:
            ...
            if 'pred_instances' in data_sample:
                ...
                #                                      classes, palette)
                pred_img_data = self._draw_instances_old(image, pred_instances,
